...
public class SheetServiceWrapper : SheetsService, ISheetServiceWrapper
{
    ...
    public SheetsService InitializeService(string accessToken, string spreadsheetId)
    {
        _spreadsheetId = spreadsheetId;
        var credential = GoogleCredential.FromAccessToken(accessToken.Trim());

        return InitializeService(credential);
    }

    public SheetsService InitializeService(Dictionary<string, string> parameters, string spreadsheetId)
    {
        _spreadsheetId = spreadsheetId;
