...
public class EntityColumnOrderIntegrationTests
{
    ...
    [Fact]
    public void AddressSheet_GetSheet_WithEntityOrdering_DoesNotThrow()
    {
        // This test ensures the integration works without exceptions
        
        // Act & Assert - Should not throw any exceptions
        var exception = Record.Exception(() => AddressSheet.GetSheet());
        
        Assert.Null(exception);
    }

    [Fact]
    public void AddressSheet_GetSheet_PreservesExistingFunctionality()
    {
    ...
    [Fact]
    public void AddressSheet_ColumnOrder_MatchesSheetConfiguration()
    {
