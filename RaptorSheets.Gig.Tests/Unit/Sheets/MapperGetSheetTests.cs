...
public class MapperGetSheetTests
{
    ...
    [Fact]
    public void TripSheet_GetSheet_ShouldGenerateKeyFormula()
    {
        // Act
    ...
    [Fact]
    public void TripSheet_GetSheet_ShouldHandleDateAsString()
    {
        // Act
        var sheet = TripSheet.GetSheet();
    ...
    [Fact]
    public void ShiftSheet_GetSheet_ShouldGenerateComplexFormulas()
    {
        // Act
        var sheet = ShiftSheet.GetSheet();
    ...
    [Fact]
    public void NameSheet_GetSheet_ShouldGenerateUniqueNameFormula()
    {
        // Act
        var sheet = NameSheet.GetSheet();
    ...
    [Fact]
    public void AddressSheet_GetSheet_ShouldCombineStartAndEndAddresses()
    {
        // Act
        var sheet = AddressSheet.GetSheet();
    ...
    [Fact]
    public void WeekdaySheet_GetSheet_ShouldGenerateWeekdayAnalysisFormulas()
    {
        // Act
        var sheet = WeekdaySheet.GetSheet();
    ...
    [Fact]
    public void MonthlySheet_GetSheet_ShouldGenerateComplexAnalysisFormulas()
    {
        // Act
        var sheet = MonthlySheet.GetSheet();
    ...
    [Fact]
    public void DeliverySheet_GetSheet_ShouldGenerateGroupedSummaryFormulas()
    {
        // Act
        var sheet = DeliverySheet.GetSheet();
        var tripsHeader = sheet.Headers.First(h => h.Name.ToString() == "Trips");
    ...
    [Fact]
    public void LocationSheet_GetSheet_ShouldGenerateGroupedSummaryFormulas()
    {
        // Act
        var sheet = LocationSheet.GetSheet();
        var firstTripHeader = sheet.Headers.First(h => h.Name.ToString() == "First Trip");
        var lastTripHeader = sheet.Headers.First(h => h.Name.ToString() == "Last Trip");
        var amountPerTripHeader = sheet.Headers.First(h => h.Name.ToString() == "Amt/Trip");
        var amountPerDistanceHeader = sheet.Headers.First(h => h.Name.ToString() == "Amt/Dist");
