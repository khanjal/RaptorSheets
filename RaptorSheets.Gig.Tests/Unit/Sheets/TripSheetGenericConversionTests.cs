...
/// <summary>
/// Tests to verify TripSheet uses GenericSheetMapper correctly
/// </summary>
public class TripSheetGenericConversionTests
{
    [Fact]
    public void TripSheet_ShouldUseGenericMapper_ForMapFromRangeData()
    {
        // Arrange
    ...
    [Fact]
    public void TripSheet_ShouldUseGenericMapper_ForMapToRangeData()
    {
        // Arrange
    ...
    [Fact]
    public void TripSheet_ShouldUseGenericMapper_ForMapToRowData()
    {
        // Arrange
        var trips = new List<TripEntity>
        {
        ...
        // Verify Date is string (FieldType.String), not serial number
        Assert.Equal(45306, row.Values[0].UserEnteredValue?.NumberValue);
    ...
    [Fact]
    public void TripSheet_ShouldUseGenericMapper_ForMapToRowFormat()
    {
        // Arrange
    ...
    [Fact]
    public void TripSheet_ShouldHandleInputOutputDistinction()
    {
        // Arrange
        var trips = new List<TripEntity>
        {
    ...
    [Fact]
    public void TripSheet_GetSheet_ShouldConfigureFormulasCorrectly()
    {
        // Act
