...
public static class ColumnNotes
{
    ...
    public const string AddressSource = "Must match a value on the Addresses sheet - add new addresses there first.";
    ...
    public const string RegionSource = "Must match a value on the Regions sheet - add new regions there first.";
    public const string ServiceSource = "Must match a value on the Services sheet - add new services there first.";
    ...
    public const string TripNameSource = "Must match a value on the Names sheet - add new names there first.";
