...
/// <summary>
/// Weekday sheet definition - layout and formulas for the Weekday sheet.
/// Designed for weekday-specific data aggregation and calculations.
/// </summary>
public static class WeekdaySheet
{
    internal static SheetModel BaseSheet => new()
    {
        Name = SheetsConfig.SheetNames.Weekdays,
    ...
    public static SheetModel GetSheet()
    {
        ...
        // Configure specific headers unique to WeekdaySheet.
