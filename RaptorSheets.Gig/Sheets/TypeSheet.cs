...
/// <summary>
/// Type sheet definition - layout and formulas for the Type sheet.
/// Tailored for trip-based data aggregation and ratio calculations.
/// </summary>
public static class TypeSheet
{
